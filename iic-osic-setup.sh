...
fi
{
	...
	echo '    mkdir $custom_dir/Raw'
	echo '    mkdir $custom_dir/Schematics'
	echo '    mkdir $custom_dir/Symbols'			
	echo '    echo "$custom_dir, $custom_dir/Raw, $custom_dir/Schematics, $custom_dir/Symbols were created"'
	echo '    echo "append XSCHEM_LIBRARY_PATH :$custom_dir" >> $HOME/.xschem/xschemrc'
	echo '  else'
